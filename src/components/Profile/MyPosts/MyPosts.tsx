...
export const MyPosts = (props: PropsType) => {
    ...
    const onPostChangeHandler = () => {
        let newPostMessage = newPostInput.current ? newPostInput.current.value : '-------';
        dispatch({type:'UPDATE-NEW-POST-INPUT', newPostMessage: newPostMessage})
    }
    ...
    return (
        <div className={styles.my__post__wrapper}>
            <h3>My posts</h3>
            <div>
                <input ref={newPostInput} onChange={onPostChangeHandler} value={postMessage}></input>
